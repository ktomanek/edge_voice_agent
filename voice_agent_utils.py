...
def get_cli_argument_parser():
    ...
    parser.add_argument("--display", choices=['colored', 'minimal'], default="colored", help="Display type: 'colored' (default) for rich console output, 'minimal' for basic LISTENING/SPEAKING status.")
